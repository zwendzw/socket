...
{
    mbedtls_printf("\n  . Check keyfile...");
    if (hasCertFile(DFL_FILENAME) == false)
    {
        mbedtls_printf( " failed\n  ! keyfile not exist! Plase create keyfile first!\n\n");
        goto exit;
    }
    else
    {
    ...
    const char *pers = "csr for sensor.live";
...
else
{
    ...
    mbedtls_printf("  - CUSTOM THING NAME:::");
    mbedtls_printf("%s", opt.subject_name);
